...
# Healthy ranges (mirrors dummy_publisher.py normal state)
c1_v       = rng.uniform(3.78, 3.86, n_samples)
c2_v       = rng.uniform(3.78, 3.86, n_samples)
c3_v       = rng.uniform(3.76, 3.84, n_samples)  # slightly tighter normal
c4_v       = rng.uniform(3.78, 3.86, n_samples)
current_a  = rng.uniform(-3.0, -0.5, n_samples)  # light discharge
max_temp_c = rng.uniform(33.0, 36.0, n_samples)  # cool operation
vibration  = rng.uniform(0.01, 0.06, n_samples)
gas_ppm    = rng.uniform(2.0, 10.0, n_samples)
