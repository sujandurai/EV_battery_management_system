...
AUTOENCODER_PATH_PTH = os.path.join(BASE_DIR, "sensor_autoencoder.pth")
AUTOENCODER_PATH_ONNX = os.path.join(BASE_DIR, "sensor_autoencoder.onnx")
ISOLATION_FOREST_PATH = os.path.join(BASE_DIR, "isolation_forest.joblib")
TRUST_THRESHOLDS_PATH = os.path.join(BASE_DIR, "trust_thresholds.json")
DETECTOR_CONFIG_PATH = os.path.join(BASE_DIR, "detector_config.json")
PREDICTIONS_CSV_PATH = os.path.join(BASE_DIR, "sensor_trust_predictions.csv")
METRICS_JSON_PATH = os.path.join(BASE_DIR, "sensor_trust_metrics.json")
